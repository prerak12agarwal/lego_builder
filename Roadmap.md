...
| Q2 | Exact categories/photo count; general scope resolved | Confirmed long-term: limited simple objects from a few images. Confirmed quick photo pilot: one clear photo; add views only with genuine provider multiview support. The local OBJ exterior converter is independent of photo categories | P2 benchmark selection |
