...
- A ready mesh automatically receives a default 24-stud handoff with unconfirmed up axis. These are saved request settings, not evidence of supported build sizes or correct orientation. Explicit new attempts retain previous results and never resubmit TRELLIS.
